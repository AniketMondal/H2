        ...
        try {
            ...
            switch (day) {
                case Calendar.MONDAY:
                    menu = jsonArray.getJSONObject(0).getString("BREAKFAST").trim();
                    break;
                case Calendar.TUESDAY:
                    menu = jsonArray.getJSONObject(1).getString("BREAKFAST").trim();
                    break;
                case Calendar.WEDNESDAY:
                    menu = jsonArray.getJSONObject(2).getString("BREAKFAST").trim();
                    break;
                case Calendar.THURSDAY:
                    menu = jsonArray.getJSONObject(3).getString("BREAKFAST").trim();
                    break;
                case Calendar.FRIDAY:
                    menu = jsonArray.getJSONObject(4).getString("BREAKFAST").trim();
                    break;
                case Calendar.SATURDAY:
                    menu = jsonArray.getJSONObject(5).getString("BREAKFAST").trim();
                    break;
