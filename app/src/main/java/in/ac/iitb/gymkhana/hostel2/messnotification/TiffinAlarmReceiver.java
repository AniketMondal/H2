        ...
        try {
            ...
            switch (day) {
                case Calendar.MONDAY:
                    menu = jsonArray.getJSONObject(0).getString("TIFFIN").trim();
                    break;
                case Calendar.TUESDAY:
                    menu = jsonArray.getJSONObject(1).getString("TIFFIN").trim();
                    break;
                case Calendar.WEDNESDAY:
                    menu = jsonArray.getJSONObject(2).getString("TIFFIN").trim();
                    break;
                case Calendar.THURSDAY:
                    menu = jsonArray.getJSONObject(3).getString("TIFFIN").trim();
                    break;
                case Calendar.FRIDAY:
                    menu = jsonArray.getJSONObject(4).getString("TIFFIN").trim();
                    break;
                case Calendar.SATURDAY:
                    menu = jsonArray.getJSONObject(5).getString("TIFFIN").trim();
                    break;
                case Calendar.SUNDAY:
                    menu = jsonArray.getJSONObject(6).getString("TIFFIN").trim();
                    break;
            }
        } catch (Exception e) {}
